...
// Driving motors 
vex::motor left_chassis1 = motor(PORT1, ratio6_1, true);
vex::motor left_chassis2 = motor(PORT2, ratio6_1, true);
vex::motor left_chassis3 = motor(PORT3, ratio6_1, true);
vex::motor_group left_chassis (left_chassis1, left_chassis2, left_chassis3);

vex::motor right_chassis1 = motor(PORT4, ratio6_1, false);
vex::motor right_chassis2 = motor(PORT5, ratio6_1, false);
vex::motor right_chassis3 = motor(PORT6, ratio6_1, false);
vex::motor_group right_chassis (right_chassis1, right_chassis2, right_chassis3);

drivetrain Drivetrain = drivetrain(left_chassis, right_chassis, 3.25, 12.75, 12, inches);
...
vex::inertial inertial_sensor(PORT9);
...
double distance_between_wheels = 12.9;

// motor to wheel gear ratio * wheel diameter (in inches) * pi
double wheel_distance_in = (36.0 / 64.0) * 3.17 * M_PI;
...
void auton() {
  ...
  top.setVelocity(0, percent);
  Drivetrain.driveFor(forward, 5.9, inches);
  Drivetrain.setTurnVelocity(20, percent);
  Drivetrain.turnFor(left, 13, degrees);
  Drivetrain.setTurnVelocity(30, percent);
  Drivetrain.driveFor(forward, 10, inches);
  wait(0.2, seconds);
  Drivetrain.driveFor(reverse, 2.4, inches);
  Drivetrain.turnFor(left, 29, degrees);
  Drivetrain.driveFor(reverse, 7.5, inches);
  top.setVelocity(100, percent);
  wait(0.2, seconds);
  top.setVelocity(0, percent);
  Drivetrain.driveFor(forward, 25.6, inches);
