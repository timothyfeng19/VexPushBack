...
void auton() {
    ...
    all.spin(forward);
    driveTo(-2, 200, true);
    turnToAngle(67, 300, true);
    driveTo(21, 800, true);
    load = true;
    driveTo(1.5, 200, true, 4);
    load = false;
    driveTo(3.5, 600, true, 4);
    wait(0.2, seconds);
    driveTo(-18, 800, true);
    turnToAngle(130, 500, true);
    load = true;
    driveTo(37.5, 1500, true);
    correct_angle = normalizeAngle(180);
    turnToAngle(180, 600, true);
    driveTo(20, 1000, true);
    wait(1, seconds);
    driveTo(-25, 1500, false);
    driveTo(-10, 1500, 4);
    wing = false;
